...
// Static call. Small and pure, so the inliner is expected to take it --
// a delta near zero says the call was removed, not that calls are free.
class BenchFreeCall {
