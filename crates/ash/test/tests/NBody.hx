// N-Body benchmark — exact copy from https://github.com/HaxeBenchmarks/benchmark-runner/blob/master/cases/nbody/NBody.hx
...
class NBody {
    ...
    public static function main() {
        ...
        Sys.println("Energy: " + Std.int(nbodies.energy() * 1000000));
    }
}
