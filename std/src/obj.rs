...
pub unsafe extern "C" fn hlp_alloc_obj(t: *mut hl::hl_type) -> *mut hl::vdynamic {
    unsafe {
        ...
        for i in 0..(*rt).nbindings {
            ...
            let field_ptr =
                (o as *mut u8).offset(field_offset as isize) as *mut *mut std::ffi::c_void;
...
pub unsafe extern "C" fn hlp_write_dyn(
    ...
    unsafe {
        ...
        match (*t).kind {
            hl_type_kind_HUI8 => {
                *(data as *mut u8) =
                    hlp_dyn_casti(&v as *const _ as *mut c_void, dyn_type, t) as u8;
            }
            hl_type_kind_HBOOL => {
                *(data as *mut bool) =
                    hlp_dyn_casti(&v as *const _ as *mut c_void, dyn_type, t) != 0;
            }
            hl_type_kind_HUI16 => {
                *(data as *mut u16) =
                    hlp_dyn_casti(&v as *const _ as *mut c_void, dyn_type, t) as u16;
            }
            hl_type_kind_HI32 => {
...
pub unsafe fn hlp_dynobj_field(o: *const vdynobj, f: *const hl_field_lookup) -> *mut c_void {
    unsafe {
        if hl_is_ptr((*f).t) {
            ((*o)
                .values
                .add(((*f).field_index & HL_DYNOBJ_INDEX_MASK as i32) as usize))
                as *mut c_void
        } else {
            ((*o)
                .raw_data
...
pub unsafe extern "C" fn hlp_get_obj_rt(ot: *mut hl_type) -> *mut hl_runtime_obj {
    unsafe {
        ...
        (*t).lookup = crate::rt::alloc_immortal(
            std::mem::size_of::<hl_field_lookup>() * (*t).nlookup as usize,
        )
        .unwrap_or_else(|| crate::rt::out_of_memory("runtime type metadata"))
        ...
        match (*(*d).t).kind {
            hl::hl_type_kind_HDYNOBJ => {
                ...
                if f.is_null() {
                    ...
                    if hl_is_ptr(t) != hl_is_ptr((*f).t)
                        || hlp_type_size(t) != hlp_type_size((*f).t)
                    {
            ...
            if address_offset != 0 {
                for i in 0..(*(*(*v).t).__bindgen_anon_1.virt).nfields as usize {
                    ...
                    if !(*vfields.add(i)).is_null()
                        && hl_is_ptr((*(*(*(*v).t).__bindgen_anon_1.virt).fields.add(i)).t)
                            == is_ptr
                    {
...
unsafe fn hl_vfields(v: *mut vvirtual) -> *mut *mut std::ffi::c_void {
    unsafe { (v as *mut u8).add(mem::size_of::<vvirtual>()) as *mut *mut std::ffi::c_void }
}
    ...
    unsafe {
        ...
        if hl_is_ptr(t) {
            ...
            *nvalues.add(index as usize) = ptr::null_mut();
            address_offset = (nvalues as *mut std::ffi::c_char)
                .offset_from((*o).values as *mut std::ffi::c_char);
            (*o).values = nvalues;
            (*o).nvalues += 1;
        } else {
            let mut raw_size = 0;
        ...
        while !v.is_null() {
            ...
            if is_ptr {
                for i in 0..(*(*(*v).t).__bindgen_anon_1.virt).nfields as usize {
                    ...
                    if hl_is_ptr((*vf).t) {
                        let pf =
                            hl_vfields(v).add((*vf).field_index as usize) as *mut *mut *mut c_void;
...
pub unsafe extern "C" fn hlp_virtual_make_value(v: *mut vvirtual) -> *mut vdynamic {
    unsafe {
        ...
        (*o).raw_size = raw_size;
        (*o).values =
            crate::rt::gc_alloc(nvalues as usize * mem::size_of::<*mut std::ffi::c_void>())
                .unwrap_or_else(|| crate::rt::out_of_memory("runtime type metadata"))
                .as_ptr() as *mut *mut std::ffi::c_void;
        (*o).nvalues = nvalues;
...
pub unsafe extern "C" fn hlp_alloc_dyn_array(n: i32) -> *mut varray {
    unsafe { crate::array::hlp_alloc_array(crate::types::hlt_dyn(), n) }
}
...
unsafe fn should_recast(t: *mut hl_type, vt: *mut hl_type) -> bool {
    unsafe {
        ...
        if (*vt).kind == hl::hl_type_kind_HNULL
            && (*(*vt).__bindgen_anon_1.tparam).kind == (*t).kind
        {
            return true;
        }
        if (*vt).kind == hl::hl_type_kind_HNULL
...
pub unsafe extern "C" fn hlp_obj_get_field(obj: *mut vdynamic, hfield: i32) -> *mut vdynamic {
    unsafe {
        ...
        match (*obj_type).kind {
            ...
            | hl_type_kind_HVIRTUAL
            | hl_type_kind_HDYNOBJ
            | hl_type_kind_HSTRUCT => hlp_dyn_getp(obj, hfield, dyn_type) as *mut vdynamic,
            _ => ptr::null_mut(),
        }
    }
}
...
pub unsafe extern "C" fn hlp_hash(name: *mut vbyte) -> i32 {
    unsafe { hlp_hash_gen(name as *const uchar, true) }
}
        ...
        match (*(*obj).t).kind {
            ...
            hl_type_kind_HVIRTUAL => {
                ...
                for i in 0..(*virt).nfields as usize {
                    *(hl_aptr::<*mut vbyte>(a)).add(i) =
                        (*(*virt).fields.add(i)).name as *mut vbyte;
                }
                a
            }
            _ => ptr::null_mut(),
